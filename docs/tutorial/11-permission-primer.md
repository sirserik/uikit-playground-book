...
Конверсия меняется кардинально. Без primer'а — 15–20% «Allow».
С primer'ом — 50–70%. Цифры из публичных кейсов Spotify, Pinterest,
Tinder. У нас в Главе будет такой же primer.
