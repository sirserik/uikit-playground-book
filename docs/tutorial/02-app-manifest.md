...
У нас в playground'е 10 мини-приложений. Каждое — со своим именем,
...
Но это путь к 10 почти одинаковым классам с copy-paste-логикой и
...
создали 10 контроллеров на старте. 10 view'ов, 10 наборов constraint'ов,
10 источников данных. Все висят в памяти, хотя пользователь, может, ни
в один и не зайдёт.
...
просто создаёт VC. Внутри может быть что угодно: передача зависимостей,
