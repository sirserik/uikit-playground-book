...
- [`UINavigationItem.titleView`](https://developer.apple.com/documentation/uikit/uinavigationitem/titleview) — слот для произвольной view (двухстрочный заголовок).
- [`UITabBarItem.badgeValue`](https://developer.apple.com/documentation/uikit/uitabbaritem/badgevalue) — текст красного бейджа.
...
- [HIG — Navigation](https://developer.apple.com/design/human-interface-guidelines/navigation-bars) — Apple про push vs modal, иерархию, табы.
