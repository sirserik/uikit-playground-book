...
В iOS 15+ Foundation умеет автоматическое грамматическое согласование через
morphology-разметку прямо в `AttributedString(localized:)` — `^[\(count)
года](inflect: true)`. Но в iOS 15 это фактически работало только для
английского, для русского — не очень. Своя функция надёжнее.
